...
def reconstruct_3d(image_paths: List[str], output_path: str) -> None:
    ...
    # Guardar la nube de puntos y el OBJ
...
def save_point_cloud(points_3d: np.ndarray, output_path: str):
    ...
    # Crear el path completo para el archivo OBJ
    obj_file_path = os.path.join(output_path, "point_cloud.obj")

    # Guardar la nube de puntos en formato OBJ usando trimesh
